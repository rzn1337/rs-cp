...
const RideManagementModal = ({ ride, isOpen, onClose, onUpdate }) => {
    ...
    const [showRemovePassengerDialog, setShowRemovePassengerDialog] =
        useState(false);
    ...
    return (
        <>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            action cannot be undone and all passengers will be
                            notified.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            <AlertDialog
                open={showRemovePassengerDialog}
                onOpenChange={setShowRemovePassengerDialog}
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {selectedPassenger?.name} from this ride? They will
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            onClick={() =>
                                handleRemovePassenger(selectedPassenger?.id)
                            }
                            disabled={isLoading}
                            className="bg-destructive text-destructive-foreground"
                        >
