...
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@/components/ui/alert-dialog"
import { User, MapPin, Calendar, Clock, Edit, Plus, X, AlertCircle, Star } from "lucide-react"

// Dummy data for ride history
const rideHistory = [
  { id: 1, from: "Downtown", to: "Airport", date: "2023-06-15", time: "14:00", price: "$25", status: "Completed", driver: "John Doe" },
  { id: 2, from: "Suburb", to: "City Center", date: "2023-06-16", time: "09:30", price: "$18", status: "Completed", driver: "Jane Smith" },
  { id: 3, from: "Beach", to: "Mountain View", date: "2023-06-17", time: "11:15", price: "$30", status: "Completed", driver: "Mike Johnson" },
  { id: 4, from: "University", to: "Shopping Mall", date: "2023-06-18", time: "13:45", price: "$15", status: "Completed", driver: "Sarah Brown" },
]
...
const initialComplaints = [
  { id: 1, rideId: 2, against: "Driver", description: "Driver was rude and unprofessional", status: "Under Review" },
  { id: 2, rideId: 3, against: "Passenger", description: "Passenger left trash in the car", status: "Resolved" },
]
    ...
    <div className="container mx-auto p-4">
                  ...
                  <TableBody>
                    {rideHistory.map((ride) => (
                      <TableRow key={ride.id}>
                        ...
                        <TableCell>
                          <Button variant="outline" size="sm" onClick={() => handleOpenComplaintDialog(ride)}>
      ...
      <Dialog open={isComplaintDialogOpen} onOpenChange={setIsComplaintDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="complaintType" className="text-right">
                Type
              </Label>
              <Select onValueChange={setComplaintType} value={complaintType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Passenger">Other Passenger</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="complaintDescription" className="text-right">
                Description
              </Label>
              <Textarea
          ...
          <DialogFooter>
            <Button type="submit" onClick={handleSubmitComplaint}>Submit Complaint</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>

      {/* ... (Edit Ride Dialog remains the same) */}
    </div>
  )
}